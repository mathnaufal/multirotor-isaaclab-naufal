...
"""Configuration for the flyrodv2 platform."""
...
FLYRODV2_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        # flyrodv2 is a two-agent setup, so only Falcon1/Falcon2 are actively configured here.
...
"""Configuration for the flyrodv2 articulation."""
